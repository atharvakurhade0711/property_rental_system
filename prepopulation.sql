EXECUTE CreateNewUser(1, 'User-1', 19, 4, 'City-1', 'State-1', 110000, 1);
EXECUTE CreateNewUser(2, 'User-2', 20, 7, 'City-2', 'State-2', 220000, 1);
EXECUTE CreateNewUser(3, 'User-3', 21, 8, 'City-3', 'State-3', 330000, 0);
EXECUTE CreateNewUser(4, 'User-4', 22, 9, 'City-4', 'State-4', 440000, 0);
EXECUTE CreateNewUser(5, 'User-5', 20, 11, 'City-5', 'State-1', 110001, 0);
EXECUTE CreateNewUser(6, 'User-6', 21, 10, 'City-1', 'State-2', 220002, 0);
EXECUTE CreateNewUser(7, 'User-7', 22, 14, 'City-2', 'State-3', 330003, 0);
EXECUTE CreateNewUser(8, 'User-8', 23, 17, 'City-3', 'State-4', 440004, 0);
EXECUTE CreateNewUser(9, 'User-9', 23, 17, 'City-4', 'State-4', 440004, 0);
EXECUTE CreateNewUser(10, 'User-10', 23, 17, 'City-5', 'State-4', 440004, 0);
...
EXECUTE RentProperty(5, 5, '14-DEC-2021', '30-OCT-2023', 10);
EXECUTE RentProperty(6, 10, '14-DEC-2021', '30-OCT-2023', 6);
EXECUTE RentProperty(7, 9, '14-DEC-2021', '30-OCT-2023', 4);
EXECUTE RentProperty(8, 8, '14-DEC-2021', '30-OCT-2023', 8);
EXECUTE RentProperty(9, 7, '14-DEC-2021', '30-OCT-2023', 5);
EXECUTE RentProperty(10, 6, '14-DEC-2021', '30-OCT-2023', 7);
EXECUTE RentProperty(10, 4, '14-DEC-2021', '30-OCT-2023', 6);
EXECUTE RentProperty(10, 2, '14-DEC-2021', '30-OCT-2023', 11);
EXECUTE RentProperty(11, 6, '14-DEC-2021', '30-OCT-2023', 4);
EXECUTE RentProperty(12, 7, '14-DEC-2021', '30-OCT-2023', 6);
EXECUTE RentProperty(13, 8, '14-DEC-2021', '30-OCT-2023', 8);
EXECUTE RentProperty(14, 9, '14-DEC-2021', '30-OCT-2023', 10);
EXECUTE RentProperty(15, 10, '14-DEC-2021', '30-OCT-2023', 12);
EXECUTE RentProperty(16, 3, '14-DEC-2021', '30-OCT-2023', 5);
EXECUTE RentProperty(16, 1, '14-DEC-2021', '30-OCT-2023', 7);
EXECUTE RentProperty(16, 5, '14-DEC-2021', '30-OCT-2023', 8);
EXECUTE RentProperty(16, 2, '14-DEC-2021', '30-OCT-2023', 4);
EXECUTE RentProperty(16, 10, '14-DEC-2021', '30-OCT-2023', 7);

INSERT INTO Property_History VALUES(1, 2, 20000, '25-FEB-2014', '5-NOV-2020', 5);
INSERT INTO Property_History VALUES(1, 3, 10000, '9-APR-2008', '30-OCT-2012', 8);
INSERT INTO Property_History VALUES(2, 4, 7500, '14-AUG-2020', '21-SEP-2022', 8);
INSERT INTO Property_History VALUES(2, 7, 8000, '14-AUG-2020', '21-SEP-2022', 8);
INSERT INTO Property_History VALUES(20, 1, 150000, '5-NOV-2015', '7-JUN-2018', 6);
INSERT INTO Property_History VALUES(20, 2, 120000, '3-AUG-2012', '14-JUL-2016', 7);
INSERT INTO Property_History VALUES(20, 3, 130000, '3-OCT-2014', '21-DEC-2018', 8);
INSERT INTO Property_History VALUES(20, 4, 135000, '17-APR-2012', '22-JUN-2016', 6);
INSERT INTO Property_History VALUES(20, 6, 120000, '20-FEB-2015', '30-NOV-2016', 8);
INSERT INTO Property_History VALUES(20, 7, 170000, '24-MAR-2012', '14-JAN-2016', 9);
